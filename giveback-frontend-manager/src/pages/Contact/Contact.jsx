...
const Contact = () => {
	...
	const [formData, setFormData] = useState({
	  ...
	  const handleSubmit = (event) => {
		...
		// For example, you could use an email sending service like EmailJS or fetch API to send the data to your backend
	...
	return (
		<div className={styles.container}>
			...
			<div>
			<button className={styles.faq_button} type="submit">Read FAQ's</button>
			</div>
			</div>
